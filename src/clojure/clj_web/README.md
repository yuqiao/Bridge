...
... artifacts are [released to Clojars](https://clojars.org/clj_web). If you are using Maven, add the following repository
...
clj_web is built from the ground up for Clojure 1.5.1 and up.


## Continuous Integration Status

[![Continuous Integration status](https://secure.travis-ci.org/clojurewerkz/clj_web.png)](http://travis-ci.org/clojurewerkz/clj_web)



## ... Is a ClojureWerkz Project

clj_web is part of the [group of Clojure libraries known as ClojureWerkz](http://clojurewerkz.org), together with
